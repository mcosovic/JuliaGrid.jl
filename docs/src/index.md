...
analysis = pmuWlsStateEstimation(system, device) # Build the state estimation model
...
analysis = dcWlsStateEstimation(system, device) # Build the state estimation model
