...
```@repl PowerFlowSolution
𝐁₁ = analysis.active.jacobian
𝐁₂ = analysis.reactive.jacobian
```
...
```@repl PowerFlowSolution
analysis.active.factorization
analysis.reactive.factorization
```
...
```@repl PowerFlowSolution
𝐡ₚ = analysis.active.increment
𝐡ₒ = analysis.reactive.increment
```
