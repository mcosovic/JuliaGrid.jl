...
Finally, after adding the generator, JuliaGrid provides the following function for adding or modifying costs for the active and reactive power generated by the generator:
* [`cost!`](@ref cost!).
