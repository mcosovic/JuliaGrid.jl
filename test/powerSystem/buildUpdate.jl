@testset "Build and Update Power System in Per-Units" begin
    ...
    @testset "Add Buses" begin
        ...
        teststruct(load.base, build.base)
    end

    @testset "Add Branches" begin
        ...
        teststruct(load.branch, build.branch)
    end

    @testset "Add Generators" begin
    ...
    @testset "Update Branches" begin
        ...
        teststruct(load.branch, build.branch; atol = 1e-14)
    end
...
@testset "Build and Update Power System in SI Units" begin
    ...
    @testset "Add Branches" begin
        ...
        teststruct(load.branch, build.branch; atol = 1e-12)
    end
