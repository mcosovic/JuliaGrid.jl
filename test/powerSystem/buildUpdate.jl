@testset "Build and Update Power System Data in Per-Units" begin
    load = powerSystem(string(pathData, "build.m"))
    rad = pi / 180
    ...
    addBranch!(build; from = 8, to = 5, susceptance = 0, turnsRatio = 0.956, shiftAngle = 2.2 * rad)
    ...
    addBranch!(build; from = 2, to = 9, reactance = 0.06, susceptance = 0, turnsRatio = 1.073)
    addBranch!(build; from = 2, to = 7, resistance = 0.05, reactance = 0.02, status = 0)
    addBranch!(build; from = 1, to = 2, resistance = 0.07, reactance = 0.09, minFromBus = -0.1, maxFromBus = 0.1, minToBus = -0.1, maxToBus = 0.1)
    ...
    ############ Update Power System ############
    load = powerSystem(string(pathData, "update.m"))
    ...
    updateBranch!(build; label = 1, status = 0, resistance = 0.05, turnsRatio = 0.89, shiftAngle = 1.2 * rad)
    updateBranch!(build; label = 8, minDiffAngle = -2 * rad, maxDiffAngle = rad)
    updateBranch!(build; label = 7, minFromBus = -5, maxFromBus = 5, minToBus = -5, maxToBus = 5, type = 1)
    ...
    updateGenerator!(build; label = 1, loadFollowing = 5, reserve10min = 3, reactiveTimescale = 4)
...
@testset "Build and Update Power System Data in SI Units" begin
    ...
    addBus!(build; active = 35e3, reactive = 15, magnitude = 0.9 * 230, maxMagnitude = 1.06 * 230)
    addBus!(build; susceptance = -10, magnitude = 0.98 * 230, angle = 7.1)
    addBus!(build; label = 9, active = 40e3, reactive = 4, base = 0.115)

    Zb1 = (230e3 * 0.956)^2 / (100e6); Zb2 = (230e3 * 1.05)^2 / (100e6); Zb3 = 230^2 / 100
    Zb4 = (115e3 * 1.073)^2 / (100e6); Zb5 = 115^2 / 100

    @branch(minDiffAngle = 0, maxDiffAngle = 360, susceptance = 0.14, resistance = 0.09, reactance = 0.02)
    addBranch!(build; from = 8, to = 5, resistance = 0.09 * Zb1, reactance = 0.02 * Zb1, susceptance = 0, turnsRatio = 0.956, shiftAngle = 2.2)
    addBranch!(build; from = 5, to = 6, resistance = 0.09 * Zb2, reactance = 0.02 * Zb2, susceptance = 0, turnsRatio = 1.05)
    addBranch!(build; from = 4, to = 6, resistance = 0.17 * Zb3, reactance = 0.31 * Zb3, susceptance = 0.14 / Zb3, status = 0)
    addBranch!(build; from = 5, to = 7, resistance = 0.01 * Zb3, reactance = 0.05 * Zb3, susceptance = 0.14 / Zb3)
    addBranch!(build; from = 2, to = 9, resistance = 0.09 * Zb4, reactance = 0.06 * Zb4, susceptance = 0, turnsRatio = 1.073)
    addBranch!(build; from = 2, to = 7, resistance = 0.05 * Zb5, reactance = 0.02 * Zb5, susceptance = 0.14 / Zb5, status = 0)
    addBranch!(build; from = 1, to = 2, resistance = 0.07 * Zb3, reactance = 0.09 * Zb3, susceptance = 0.14 / Zb3, minFromBus = -10e-3, maxFromBus = 10e-3, minToBus = -10e-3, maxToBus = 10e-3)
    addBranch!(build; from = 4, to = 9, resistance = 0.08 * Zb3, reactance = 0.30 * Zb3, susceptance = 0.14 / Zb3)

    @generator(minReactive = -50, maxReactive = 90)
    addGenerator!(build; bus = 1, active = 370e3, maxReactive = 175, maxActive = 472e3)
    addGenerator!(build; bus = 2, active = 210e3, magnitude = 1.1 * 115, maxActive = 316e3, status = 0)
    ...
    Zb1 = 230^2 / 100; Zb2 = 120^2 / 100; Zb3 = (230e3 * 0.89)^2 / (100e6)

    updateBranch!(build; label = 3, status = 1, susceptance = 0.1 / Zb1)
    updateBranch!(build; label = 6, status = 1, resistance = 0.08 * Zb2, reactance = 0.04 * Zb2)
    updateBranch!(build; label = 2, status = 0)
    updateBranch!(build; label = 1, status = 0, resistance = 0.05 * Zb3, turnsRatio = 0.89, shiftAngle = 1.2)
    updateBranch!(build; label = 8, minDiffAngle = -2, maxDiffAngle = 1)
    updateBranch!(build; label = 7, minFromBus = -0.5, maxFromBus = 0.5, minToBus = -0.5, maxToBus = 0.5, type = 1)
    ...
    updateGenerator!(build; label = 1, loadFollowing = 500e3, reserve10min = 300e3, reactiveTimescale = 400)
