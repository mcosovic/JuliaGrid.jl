@testset "addBus!, addGenerator!, addBranch!" begin
    ...
    addBus!(systemPU; label = 152, type = 3, active = 0.17, reactive = 0.09, magnitude = 1.0535, angle = 9.24 * rad, minMagnitude = 0.94, maxMagnitude = 1.06, base = 230e3)
    addBus!(systemPU; label = 153, type = 2, magnitude = 1.0435, angle = 10.46 * rad, minMagnitude = 0.94, maxMagnitude = 1.06, base = 230e3)
    addBus!(systemPU; label = 154, type = 1, active = 0.7, reactive = 0.05, susceptance = 0.345, magnitude = 0.9663, angle = -1.8 * rad, minMagnitude = 0.94, maxMagnitude = 1.06, base = 115e3)
    addBus!(systemPU; label = 155, type = 1, active = 2, reactive = 0.5, magnitude = 1.0177, angle = 6.75 * rad, minMagnitude = 0.94, maxMagnitude = 1.06, base = 230e3)
    addBus!(systemPU; label = 156, type = 1, active = 0.75, reactive = 0.5, magnitude = 0.963, angle = 5.15 * rad, minMagnitude = 0.94, maxMagnitude = 1.06, base = 115e3)
    addBus!(systemPU; label = 161, type = 1, active = 0.35, reactive = 0.15, magnitude = 1.036, angle = 8.85 * rad, minMagnitude = 0.94, maxMagnitude = 1.06, base = 230e3)
    addBus!(systemPU; label = 164, type = 1, susceptance = -2.12, magnitude = 0.9839, angle = 9.66 * rad, minMagnitude = 0.94, maxMagnitude = 1.06, base = 230e3)
    addBus!(systemPU; label = 183, type = 1, active = 0.4, reactive = 0.04, magnitude = 0.9717, angle = 7.12 * rad, minMagnitude = 0.94, maxMagnitude = 1.06, base = 115e3)
