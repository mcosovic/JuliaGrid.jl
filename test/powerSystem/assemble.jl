@testset "addBus!, addGenerator!, addBranch!" begin
    ...
    addBus!(systemPU; label = 154, type = 1, active = 0.7, reactive = 0.05, susceptance = 0.345, magnitude = 0.9663, angle = -1.8 * rad, base = 115e3)
    addBus!(systemPU; label = 155, type = 1, active = 2, reactive = 0.5, magnitude = 1.0177, angle = 6.75 * rad, base = 230e3)
    addBus!(systemPU; label = 156, type = 1, active = 0.75, reactive = 0.5, magnitude = 0.963, angle = 5.15 * rad, base = 115e3)
    addBus!(systemPU; label = 161, type = 1, active = 0.35, reactive = 0.15, magnitude = 1.036, angle = 8.85 * rad, base = 230e3)
