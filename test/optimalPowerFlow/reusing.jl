@testset "Reusing AC Optimal Power Flow" begin
    ...
    addBranch!(system; label = 22, from = 4, to = 5, reactance = 0.25, minFromBus = -0.18, maxFromBus = 0.18, minToBus = -0.18, maxToBus = 0.18, maxDiffAngle = 0.15, type = 2)
    ...
    addBranch!(resystem, reusing; label = 22, from = 4, to = 5, reactance = 0.25, minFromBus = -0.18, maxFromBus = 0.18, minToBus = -0.18, maxToBus = 0.18, maxDiffAngle = 0.15, type = 2)
    ...
    updateBranch!(system; label = 22, reactance = 0.35, minFromBus = -0.22, maxFromBus = 0.22, minToBus = -0.22, maxToBus = 0.22)
    ...
    updateBranch!(resystem, reusing; label = 22, reactance = 0.35, minFromBus = -0.22, maxFromBus = 0.22, minToBus = -0.22, maxToBus = 0.22)
...
@testset "Reusing DC Optimal Power Flow" begin
    ...
    addBranch!(system; label = 21, from = 5, to = 7, reactance = 0.25, turnsRatio = 0.98, shiftAngle = -0.1, status = 0)
    addBranch!(system; label = 22, from = 4, to = 5, reactance = 0.25, minFromBus = -0.18, maxFromBus = 0.18, minToBus = -0.18, maxToBus = 0.18, maxDiffAngle = 0.15)
    updateBranch!(system; label = 21, status = 1)
    ...
    addBranch!(resystem, reusing; label = 21, from = 5, to = 7, reactance = 0.25, turnsRatio = 0.98, shiftAngle = -0.1, status = 0)
    addBranch!(resystem, reusing; label = 22, from = 4, to = 5, reactance = 0.25, minFromBus = -0.18, maxFromBus = 0.18, minToBus = -0.18, maxToBus = 0.18, maxDiffAngle = 0.15)
    updateBranch!(resystem, reusing; label = 21, status = 1)
