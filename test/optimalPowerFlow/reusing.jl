@testset "DC Optimal Power Flow" begin
   ...
   cost!(system; label = 9, model = 1, piecewise = [10.2 14.3; 11.5 16.1; 12.8 18.6])
   addGenerator!(system; label = 10, bus = 3, active = 0.3)
   cost!(system; label = 10, model = 1, piecewise = [10.2 14.3; 11.5 16.1])
   ...
   cost!(system; label = 5, model = 2, polynomial = [854.0, 116.0])
   ...
   cost!(resystem, reusing; label = 9, model = 1, piecewise = [10.2 14.3; 11.5 16.1; 12.8 18.6])
   addGenerator!(resystem, reusing; label = 10, bus = 3, active = 0.3)
   cost!(resystem, reusing; label = 10, model = 1, piecewise = [10.2 14.3; 11.5 16.1])
   ...
   cost!(resystem, reusing; label = 5, model = 2, polynomial = [854.0, 116.0])
   ...
   cost!(system; label = 11, model = 2, polynomial = [165.0])
   cost!(system; label = 10, model = 1, piecewise = [10.2 14.3; 11.5 16.1; 12.8 18.6])
   cost!(system; label = 9, model = 2, polynomial = [856.2; 135.3; 80])
   ...
   cost!(resystem, reusing; label = 11, model = 2, polynomial = [165.0])
   cost!(resystem, reusing; label = 10, model = 1, piecewise = [10.2 14.3; 11.5 16.1; 12.8 18.6])
   cost!(resystem, reusing; label = 9, model = 2, polynomial = [856.2; 135.3; 80])
