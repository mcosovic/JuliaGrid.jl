...
mpc.bus = [
	...
	7	1	0       0       12	0	1	1.062	-13.37	0	1	1.06	0.94;
...
mpc.gen = [
	...
	2	40      42.4	50      -40	1.045	100     1       30      5       7	30      -40	50      -2	2       0	0	0	0	0;
...
mpc.branch = [
	...
	2	3	0.04699	0.19797	0.0438	0	0	0	0       0       1	-5      5;
	...
	4	5	0.01335	0.04211	0       22	0	0	0       0       1	-360	360;
	4	7	0	0.20912     0       0	0	0	0.978	0       1	-360	360;
	4	9	0	0.55618     0       0	0	0	0.969	0.12	1	-360	360;
	...
	7	9	0	0.11001     0       0	0	0	0       0       0	-360	360;
...
mpc.gencost = [
	...
	2	0	0	3	0.25            20          150     0         0           0           0       0;
	2	0	0	4	0.01            40          150     300           0           0           0       0;
	2	0	0	3	0.01            40          0       0           0           0           0       0;
	1	0	0	4	140             3582.87481	210     4981.72313	280         6497.03117  350     8137.67767; 
    2	0	0	3	0.0430292599	20          0       0           0           0           0       0;
	2	0	0	4	0.01            20          80     100           0           0           0       0;
	2	0	0	4	0.01            40          150     300           0           0           0       0;
	1	0	0	4	100             2572.87481	150     3572.72313	200         5572.03117  300     7572.67767;
	1	0	0	4	60              1550.87481	80     2550.72313	90         3550.03117  100     5550.67767;     
];
