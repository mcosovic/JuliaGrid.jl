...
Base.@kwdef mutable struct GeneratorTemplate
    ...
    maxActive::ContainerTemplate = ContainerTemplate(Inf, 0.0)
    minReactive::ContainerTemplate = ContainerTemplate(-Inf, 0.0)
    maxReactive::ContainerTemplate = ContainerTemplate(Inf, 0.0)
